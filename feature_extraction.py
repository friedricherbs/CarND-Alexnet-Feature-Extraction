...
# Fully connected layer. This should have 43 outputs.
w = tf.Variable(tf.truncated_normal([shape[0], nb_classes], stddev=1e-2) )
b = tf.Variable(tf.zeros(nb_classes))
probs = tf.nn.softmax(tf.add(tf.matmul(fc7, w), b))
